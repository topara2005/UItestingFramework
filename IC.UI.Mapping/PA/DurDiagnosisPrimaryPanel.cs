...
{
    public class DurDiagnosisPrimaryPanel : DataPanel
    {
        ...
        public DurDiagnosisPrimaryPanel(ITestVisitor visitor) : base(visitor)
        {
        ...
        public override string PanelTestPrefixAttribute => "primdiagnosis";


        public virtual SelectElement DropBoxPrimaryDiagnoisis =>new SelectElement( GetWebElement("DiagIePrimIndicator"));
        public virtual SelectElement DropBoxLinkIndicator =>new SelectElement( GetWebElement("LinkIndicator"));
        public virtual IWebElement TxtDoseRatio => GetWebElement("PrimDiagDoseRatioNumber");


        public virtual IWebElement TxtDaysSupply => GetWebElement("PrimDiagDaySplyNumber");
